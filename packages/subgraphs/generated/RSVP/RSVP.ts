...
export class RSVP__eventsResult {
  value0: Bytes;
  value1: string;
  value2: Address;
  value3: BigInt;
...
export class RSVP extends ethereum.SmartContract {
  ...
  events(param0: Bytes): RSVP__eventsResult {
    let result = super.call(
      "events",
      "events(bytes32):(bytes32,string,address,uint256,uint256,uint256,bool)",
      [ethereum.Value.fromFixedBytes(param0)]
    );

    return new RSVP__eventsResult(
      result[0].toBytes(),
      result[1].toString(),
      result[2].toAddress(),
      result[3].toBigInt(),
  ...
  try_events(param0: Bytes): ethereum.CallResult<RSVP__eventsResult> {
