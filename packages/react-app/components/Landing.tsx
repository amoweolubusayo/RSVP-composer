      ...
      <section className="py-12">
        <div className="w-full md:w-8/12 text-left">
          <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
            <span>Find and attend events happening in the </span>
            <span className="text-indigo-600">Celo Sage ecosystem</span>
          </h1>
          <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
            Find, join, and create virtual events with your favorite celo sages!
          </p>
        </div>
      </section>
